...
loader = DataLoader(AugmentedLocalData(mode='test'), batch_size=1, num_workers=1)
...
for i,sample in enumerate(loader):
	...
	np.save('/Users/user/Code/Astronomy/exp4/notebooks/test/best/i{}.npy'.format(i),
		input_batch.data.numpy())
	np.save('/Users/user/Code/Astronomy/exp4/notebooks/test/best/l{}.npy'.format(i),
		img_batch.data.numpy())
	np.save('/Users/user/Code/Astronomy/exp4/notebooks/test/best/o{}.npy'.format(i),
