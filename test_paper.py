...
net = Net()
net.load_state_dict(torch.load('experiments/checkpoint_paper',
		map_location=lambda storage, loc:storage))
net.eval()

loader = DataLoader(AugmentedLocalData(), batch_size=1, num_workers=1)
...
for i,sample in enumerate(loader):
	...
	output_batch, pred_batch = net(input_batch)
