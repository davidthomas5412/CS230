...
"""
Run with gradient clipping (10) and new random seeds (10)
"""
...
class SimpleConfig:
	def __init__(self):
		...
		self.checkpoint_path = 'experiments/checkpoint_paper6'
		self.best_checkpoint_path = 'experiments/checkpoint_paper6_best'
